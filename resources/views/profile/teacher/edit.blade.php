            ...
            <div class="row ">
                <div class="col-lg-4 ">
                    <div class="ms-4">
                        ...
                        @endforeach
                    @endif
                        <form method="post" action="{{route('teacher.profile.upload')}}" enctype="multipart/form-data">
                            @csrf
                        <span class="uploadfile ms-4">
                        @if ($user->profile_image)
                        <img src="{{ asset('assets/files/teacher/profile/'.$user->profile_image) }}" class="rounded-circle"
                            alt="">
                        @else
