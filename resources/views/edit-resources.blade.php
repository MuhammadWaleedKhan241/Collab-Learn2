                                    ...
                                    <tr class="search-items">
                                        ...
                                        <td>
                                            <div class="action-btn">
                                                <a href="edit/{{ $record->id }}" class="text-info edit">
                                                    <i class="ti ti-edit fs-5 btn btn-outline-success"></i>
                                                </a>
                                                <a href="delete/{{ $record->id }}" class="text-dark delete ms-2 ">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid bg-light">
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ route('admin.update.resources', $data->id) }}" method="POST"
